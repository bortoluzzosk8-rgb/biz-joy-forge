        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#plans" className="text-background/70 hover:text-primary transition-colors">
                  Planos
                </a>
              </li>
              <li>
          ...
          {/* Account */}
          <div>
            <h3 className="font-semibold mb-4 text-lg">Conta</h3>
            <ul className="space-y-2">
              <li>
                <Link to="/admin-login" className="text-background/70 hover:text-primary transition-colors">
                  Login
                </Link>
              </li>
              <li>
